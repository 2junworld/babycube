...
import {
  SEED_INGREDIENTS, GROWTH_STAGES, growthStageOf,
  NUTRIENT_TAGS, TAG_LABELS, TAG_KEYS, DB_CATEGORY, PAIRING_RULES,
} from "./data/nutrition";
import {
  seedState, migrateState, reducer,
  stockBatches, stockTotalCubes, stockTotalFrozenG, stockFridgeG,
  deductFrozen, deductFridge, restoreFrozen, restoreFridge,
  restoreLogDeductions, redeductLogDeductions,
  isStaple, avgPlannedMealsPerDay, ensureIngredientEntry,
  normalizeIngredientName, unrestorableStockNames,
  catOf, unitGOf, gOf, totalG, logProvideG, catTotals, sortByCategory,
} from "./state/appState";
import { Store, useStore } from "./store";
import {
  CubeMark, CubeGrid, Segmented, CatDot, CategoryLegend, CategoryBar, CategoryTotalsBar,
  MealItemList, IngredientTable, StatusBadge, FromRecordBadge, ScreenHeader, SubHeader,
  NumInput, ConfirmModal, useVisualViewport, TimePicker, BottomSheet,
